    ...
    def __init__(self, root, split='train',
        ...
        if self.split is 'label' or self.split is 'unlabel' or self.split is 'valid':
            ...
            if self.split is 'label':
                ...
                self.valid_data = self.valid_data.reshape((len(valid_data1), 3, self.height, self.width))  # reshape to (B,C,H,W)
...
if __name__ == '__main__':
    ...
    print("check label iteration part-------------------------------------------------------------------")
